 ...
 * Date: 3/27/24
 * 
 * (Implement inorder traversal without using recursion) Implement 
 * the inorder method in BST using a stack instead of recursion.  
 * Exercise25_03 prompts the user to enter 10 integers, stores them 
...
public class Exercise25_03 {
  public static void main(String[] args) {
    ...
    BST<String> tree1 = new BST<String>();
    tree1.insert("George");
  ...
  public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void nonRecursiveInorder() {
      ...
      ArrayList<E> stack = iterator.list;
